...
if (isset($_GET['id'])){
    ...
    while ($row = fetch_array($query)) {
        ...
        $product_author = escape_string($row['product_author']);
...
<div class="col-md-12">
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="col-md-8">
            ...
            <div class="form-group">
                <label for="product-title">Product author </label>
                <input type="text" name="product_author" class="form-control" value="<?php echo $product_author; ?>">
