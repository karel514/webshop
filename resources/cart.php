...
//toon button functie les 51. de button buy now toont zich enkelm als er een product geselecteerd geweest is en als er iets staat in checkout.
        ...
        foreach ($_SESSION as $name => $value) {
            ...
            if ($value > 0) {
                ...
                if (substr($name, 0, 8) == "product_") {
                    ...
                    $id = substr($name, 8, $length);
//deze query zet gegevens in de orders tabel ^^
